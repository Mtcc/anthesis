...
class FerriteEditor : public juce::AudioProcessorEditor,
                    private juce::Timer
{
public:
    explicit FerriteEditor (FerriteProcessor&);
...
private:
    ...
    float scopeIn  [FerriteProcessor::kScopeSize] = {};
    float scopeOut [FerriteProcessor::kScopeSize] = {};
    int   scopeReadPos = 0;
