...
// shared color constants for the Mycelium plugin
namespace AC
{
...
class MyceliumLookAndFeel : public juce::LookAndFeel_V4
{
public:
    MyceliumLookAndFeel();
    ...
    // draw spore-burst overlay on macro knobs
...
private:
    ...
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (MyceliumLookAndFeel)
};
