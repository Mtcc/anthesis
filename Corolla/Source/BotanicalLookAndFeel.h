...
// shared color constants for the Corolla plugin
namespace AC
{
...
class CorollaLookAndFeel : public juce::LookAndFeel_V4
{
public:
    CorollaLookAndFeel();
    ...
    // draw petal bloom overlay on macro knobs
...
private:
    ...
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (CorollaLookAndFeel)
};
